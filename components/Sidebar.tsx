...
export default function Sidebar() {
  ...
  return (
    <aside className="w-56 bg-stone-900 text-stone-100 flex flex-col flex-shrink-0 h-full">
      {/* Logo / Brand */}
      <div className="px-5 py-5 border-b border-stone-700">
        <div className="flex items-center gap-2.5">
          <div className="w-7 h-7 bg-amber-500 rounded flex items-center justify-center flex-shrink-0">
            <svg className="w-4 h-4 text-stone-900" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="px-5 py-4 border-t border-stone-700">
        <p className="text-[10px] text-stone-500">Phase 2 — UI Scaffold</p>
      </div>
    </aside>
  );
}
